            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="mb-3 col-sm-12 col-mb-6 col-xl-6">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="Nombre del cuestionario" required value="{{old('name')}}" >
                </div>
                ...
                <div class="row">  
                    <div class="mb-3 col-sm-12 col-mb-12 col-xl-12 ">
                        ...
                        <textarea name="description" id="description_id" value="" placeholder="Descripción del cuestionario" class="form-control" rows="10">{{old('description')}}</textarea>
                    </div>
                </div>
