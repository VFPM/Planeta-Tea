            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="mb-3 col-sm-12 col-mb-6 col-xl-6">
                        ...
                        <select  class="form-control" id="tipo_pregunta" name="question_type_id" placeholder="Tipo de pregunta" required>
...
<script>
  $(document).ready(function () {
    ...
    const inputRespuesta = (num) => {
        
        return `<div class="mb-3 col-sm-12 col-mb-6 col-xl-6 respuesta"  style="position:relative;">
                    <button type="button" class="btn btn-sm btn-danger delete-respuesta" style="position:absolute;  height: 100%;">X</button>
                    <input type="text" class="form-control" id="pregunta_id" name="respuestas[]" placeholder="Respuesta" required style="padding-left:30px;">
                </div>`
    };
    ...
    $("#tipo_pregunta").on('change', function(){
        ...
        if(option === '2'){
            ...
            for (let i = 0; i < 2; i++) {
                $("#respuestas-contenedor").append(inputRespuesta(total));  
                total++;         
            }
    ...
    $("#respuestas-multiples").on('click',".delete-respuesta",  function(){
        if(numeroRespuestas > 2){
            ...
            alert('Una pregunta de opción múltiple debe tener almenos 2 respuestas diferentes.');
        }
    });
